                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                if (dataSnapshot.exists()) {
                                                    ...
                                                    if ("Customer".equals(userRole)) {
                                                        ...
                                                        // Display an error message if the role is not "Customer"
                                                        ReusableCodeForAll.ShowAlert(Login.this, "Error", "You are not a registered Customer.");
                                                    }
                                                }
                                            }
                                    ...
                                    if (errorMessage.contains("INVALID_LOGIN_CREDENTIALS")) {
                                        ...
                                        ReusableCodeForAll.ShowAlert(Login.this, "Error", "The password is incorrect or the user does not exist.");
                                    } else {
                                        // Show a generic error message for other errors
                                        ReusableCodeForAll.ShowAlert(Login.this, "Error", errorMessage);
                                    }
                                }
                            }
                        });
